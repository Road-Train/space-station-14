...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string> RulesFile =
        CVarDef.Create("server.rules_file", "AfterlightRules", CVar.REPLICATED | CVar.SERVER);

    /// <summary>
    ///     Guide entry that is displayed by default when a guide is opened.
    /// </summary>
    public static readonly CVarDef<string> DefaultGuide =
        CVarDef.Create("server.default_guide", "ALNewPlayer", CVar.REPLICATED | CVar.SERVER);
